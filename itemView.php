	...
	<div class="banner">
		...
		<div class="w3l_banner_nav_right col-md-7">
			...
			<div class="w3l_banner_nav_right_banner3">
				<h3 style="font-size: 20px;">Best Deals For New Products<span class="blink_me"></span></h3>
			</div>
	...
	<div class="w3ls_w3l_banner_nav_right_grid w3ls_w3l_banner_nav_right_grid_popular">
		<div class="container">
				...
				<div class="w3ls_w3l_banner_nav_right_grid1">
					...
					<div class="col-md-9 w3ls_w3l_banner_left">
					
                  
                        <p style="font-weight: bolder;" class="active" >Specifications</p>
