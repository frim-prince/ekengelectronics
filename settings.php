                ...
                $fullName=$fname. ' ' .$surname;
                 ...
                 if ($countUser>0) {
                 	...
                 	if($run_insertCustomer){
                            ...
                            $to_email = $email;
                             $subject = 'Ekeng Electronics Registration';
                             ...
                             $message.=''."\r\n";
                             $message.=''."\r\n";
                             $message.='Keep this confidential. You can update your credentials when your login to your profile';
                             $headers = 'From:frimprincy@gmail.com';
                             $send= mail($to_email, $subject, $message, $headers);
                           if (!$send) {
                               echo "<script>swal.fire({
                                 title: 'Email Sending Error',
                                 text: 'Email Sending Failled.Contact Us For Your Credentials',
                                 icon: 'error',
                           	 	...
                           	 	echo "<script>swal.fire({
                                 title: 'Email Sent!',
                                 text: 'Your Credentials For Login Have Been Sent To Your Email',
                                 icon: 'success',
